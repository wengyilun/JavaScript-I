...
const carYears = []; //Object.values(inventory);

for (let value of Object.values(inventory)) {
    //if(!carYears.includes(value['car_year'])){
        carYears.push(value['car_year']); 
    //}
  }
console.log('carYears', carYears.sort())


// ==== Challenge 5 ====
// The car lot manager needs to find out how many cars are older than the year 2000. Using the carYears array you just created, find out how many cars were made before the year 2000 by populating the array oldCars and logging it's length.
let oldCars = [];
for (let value of carYears) {
    if(value > 2000){
        oldCars.push(value);
    }
}
console.log('Number of Old Cars:', oldCars.length); 
